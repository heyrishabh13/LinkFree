...
Start with creating a fork of the repository. You can do so using the [Quickstart guide](https://linkfree.io/docs/quickstart)

<a href="https://linkfree.io/docs/quickstart" target="_blank" rel="noopener noreferrer">Quickstart guide</a>


Now open your fork and follow along.
